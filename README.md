...
```
cd existing_repo
git remote add origin https://git.lab.karpov.courses/a-skaletskaja/memory-game.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.lab.karpov.courses/a-skaletskaja/memory-game/-/settings/integrations)
